...
Class sarksplash {
	...
	private function showMain() { 
		...
		echo '<div class="w3-col w3-display-container  m12 l12" style="height:40px;">';
		echo '<div id="sys_div" class="w3-container w3-display-left"></div>';
		echo '</div>';
